...
export default function GuessWord() {
    ...
    const scoreWordGuessed = () => {
        appFirebase.databaseApi.readOnce(`games/${game.gameId}/${game.ownTeam}score`, (snapshot) =>
            appFirebase.databaseApi.update(`games/${game.gameId}/scores/`, {greenTeamScore: 1}, updateDone)
    );
